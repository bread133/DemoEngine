...
Collision::Collision(Object* first, Object* second)
{
	...
	// first, если коллизи€ происходит между параллелепипедом и сферой
	...
	case NONE:
		break;
	default:
		throw("Ќекорректный тип фигуры. вычисление коллизии не представл€етс€ возможным.");
	}
}
...
bool Collision::collision_detector()
{
	...
	// компил€ции, да и выглд€дит локанично
	switch (mask)
	{
	case SPHERE | SPHERE:
	...
	case NONE | PARALLELEPIPED:
		return false;
	default:
		throw("≈сть необработанные коллизии. ќбработайте их.");
	}
}
